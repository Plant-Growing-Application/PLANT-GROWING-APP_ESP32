...
| **AP fallback** | Kopmadan **5 sn** sonra AP açılır, **STA denemesi arka planda sürer** (AP_STA). Ağ geri gelince otomatik STA'ya döner. Eşik önce 90, sonra 45 sn'ydi: internet gittiğinde cihaza ulaşılamayan bir dakika demekti. Erken açmanın maliyeti yok — AP, STA denemesini durdurmuyor. | Yalnızca boot'ta bir kez AP'ye düşülüyordu; çalışma sırasında kopma kalıcıydı |
